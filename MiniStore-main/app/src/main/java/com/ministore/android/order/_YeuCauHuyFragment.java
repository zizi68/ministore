...
public class _YeuCauHuyFragment extends Fragment {
    ...
    private void loadList() {
        ...
        ApiService.apiService.getShipperOrderByStatus(authorization, _OrderFragment.YEU_CAU_HUY,userId).enqueue(new Callback<List<Order>>() {
            @Override
