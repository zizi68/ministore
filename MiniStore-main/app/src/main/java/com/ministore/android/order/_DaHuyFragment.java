...
public class _DaHuyFragment extends Fragment {
    ...
    private void loadList() {
        ...
        ApiService.apiService.getShipperOrderByStatus(authorization, _OrderFragment.DA_HUY,userId).enqueue(new Callback<List<Order>>() {
            @Override
