...
public class FeedbackAdapter extends RecyclerView.Adapter<FeedbackAdapter.FeedbackViewHolder>{
    ...
    public void onBindViewHolder(@NonNull FeedbackViewHolder holder, int position) {
        ...
        User userOrder = feedback.getOrderDetail().getOrder().getUser();
        Picasso.get().load(ApiService.USER_IMAGE_URL + userOrder.getImage()).into(holder.imgUserAvatar);
        holder.tvUser.setText(userOrder.getLastName() + " " + userOrder.getFirstName());
