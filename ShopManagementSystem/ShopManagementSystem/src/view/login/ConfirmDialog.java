...
public class ConfirmDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel_ShowHide = new javax.swing.JLabel();
        ...
        jLabel_ShowHide.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/hide.png"))); // NOI18N
        jLabel_ShowHide.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jLabel_ShowHideMouseClicked(evt);
            }
        });
...
//        JOptionPane.showMessageDialog(null, "Đổi mật khẩu thành công!");
    ...
    private void jLabel_ShowHideMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel_ShowHideMouseClicked
        // TODO add your handling code here:
        if (showPassNew) {
            showPassNew = false;
            jLabel_ShowHide.setIcon(new ImageIcon(getClass().getResource("/img/hide.png")));
            jPasswordField_NewPasword.setEchoChar('*');
        } else {
            showPassNew = true;
            jLabel_ShowHide.setIcon(new ImageIcon(getClass().getResource("/img/show.png")));
            jPasswordField_NewPasword.setEchoChar('\u0000');
        }
    }//GEN-LAST:event_jLabel_ShowHideMouseClicked
...
//    }
    ...
    private javax.swing.JLabel jLabel_ShowHide;
