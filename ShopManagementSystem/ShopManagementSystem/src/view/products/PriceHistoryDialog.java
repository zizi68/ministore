...
public class PriceHistoryDialog extends javax.swing.JDialog {
     ...
     */
    public PriceHistoryDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        pc = new PriceHistoryController();
        List<PriceHistory> list = pc.getPriceHistoryByProductId(PanelProduct.selectedProductId);
        DefaultTableModel dtm = (DefaultTableModel) jTable_PriceHistory.getModel();
        SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy HH:mm");
        Vector vt;
        int sum = 0;
        for (PriceHistory f : list) {
            vt = new Vector();
            vt.add(sdf.format(f.getDate()));
            vt.add(f.getUser().getUsername());
            vt.add(f.getUser().getEmail());
            vt.add(f.getPrice());
            dtm.addRow(vt);
        }
        this.getContentPane().setBackground(Color.WHITE);
        jLabel_ProductName.setText(PanelProduct.selectedProductName);
        jLabel_MaxPrice.setText(pc.getPriceByOption("max", PanelProduct.selectedProductId).getPrice().toString());
        jLabel_MinPrice.setText(pc.getPriceByOption("min", PanelProduct.selectedProductId).getPrice().toString());
        jLabel_AvgPrice.setText(pc.getPriceByOption("avg", PanelProduct.selectedProductId).getPrice().toString());
    ...
    private void initComponents() {
        ...
        jTable_PriceHistory = new javax.swing.JTable();
        ...
        jLabel_ImportHistory.setText("Price History");

        jTable_PriceHistory.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Date", "Username", "Email", "Price"
            }
        ) {
        ...
        jScrollPane1.setViewportView(jTable_PriceHistory);
    ...
    private void jTextField_NameSearchCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField_NameSearchCaretUpdate
        ...
        TableRowSorter<TableModel> trs = new TableRowSorter<>(jTable_PriceHistory.getModel());
        jTable_PriceHistory.setRowSorter(trs);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PriceHistoryDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PriceHistoryDialog dialog = new PriceHistoryDialog(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTable_PriceHistory;
